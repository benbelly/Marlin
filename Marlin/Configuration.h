...
#define STRING_CONFIG_H_AUTHOR "Ben Holm" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Enderman"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    // PID Tune for new 60W heat cartridge
    #define DEFAULT_Kp  13.69
    #define DEFAULT_Ki   1.21
    #define DEFAULT_Kd  38.88
  #endif
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.5, 79.8, 414.5, 143.2 }
